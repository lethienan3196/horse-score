...
| TO-DO | `.planning/TO-DOs/pending/{slug}.md` | Concrete actionable tasks identified |
...
2. **TO-DO:** "Evaluate Passport.js vs custom middleware" — the comparison you want to do
...
- **TO-DOs:** Create `.planning/TO-DOs/pending/{slug}.md` with frontmatter (title, date, priority)
