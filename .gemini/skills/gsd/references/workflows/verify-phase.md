...
|---------|--------|----------|
| TO-DO/FIXME/XXX/HACK | `grep -n -E "TO-DO\|FIXME\|XXX\|HACK"` | ⚠️ Warning |
...
```bash
grep -rn -E "it\.skip|describe\.skip|test\.skip|xit\(|xdescribe\(|xtest\(|@pytest\.mark\.skip|@unittest\.skip|#\[ignore\]|\.pending|it\.TO-DO|test\.TO-DO" "$TEST_FILE"
```
