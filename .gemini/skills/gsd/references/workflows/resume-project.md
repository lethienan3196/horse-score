...
- **Pending TO-DOs**: Ideas captured during sessions
...
[If pending TO-DOs exist:]
📋 [N] pending TO-DOs — /gsd-check-TO-DOs to review
...
3. Check pending TO-DOs ([N] pending)
...
- **Check TO-DOs** → Read .planning/TO-DOs/pending/, present summary
...
4. Count pending TO-DOs in .planning/TO-DOs/pending/
